...
const VISUAL_SOURCE_HELP: Record<VisualSource, string> = {
  ai: "Every scene is generated by AI (Veo video + nano-banana images). Use this for fictional or dramatized content — e.g. animal battle matchups.",
  science:
    "For real subjects (a planet, a telescope, a named scientist) it pulls a REAL photo from Wikipedia with the name on screen. Generic / abstract scenes still use AI.",
};

const BATTLE_HELP =
  "Adds an intro “VS” stat card (e.g. weight / bite force / speed) at the start of the video. " +
  "It works ON TOP of any visual source — so an AI-generated battle = Visual source “AI generated” + this set to On.";
...
function badge(c: Channel): string {
  const parts = [c.visual_source === "science" ? "real images" : "AI"];
  ...
  return (
    <div>
      ...
      <p style={{ color: "var(--fg-muted)", marginBottom: 16, lineHeight: 1.6 }}>
        ...
        the <strong>New run</strong> page and the run uses its prompts and settings. A new channel
        starts from your global <a href="/prompts">Prompts</a> defaults.
      </p>
      ...
      <div style={{ display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap" }}>
            ...
            {channels.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="badge badge-neutral">{badge(c)}</span>
                </button>
              );
            })}
          </div>
        ...
        {editing ? (
          <div className="card" style={{ flex: 1, minWidth: 360, display: "grid", gap: 14 }}>
            ...
            <div>
              <label className="label">Visual source — how scenes are made</label>
              <select
                className="input"
                value={editing.visual_source}
                onChange={(e) => set("visual_source", e.target.value as VisualSource)}
              >
                <option value="ai">AI generated (Veo + nano-banana)</option>
              ...
              <p style={{ color: "var(--fg-faint)", fontSize: 12.5, marginTop: 6, lineHeight: 1.5 }}>
                {VISUAL_SOURCE_HELP[editing.visual_source]}
              </p>
            </div>
            ...
            <div style={{ borderTop: "1px solid var(--border)", paddingTop: 12, display: "grid", gap: 12 }}>
              <div>
                ...
                <p style={{ color: "var(--fg-faint)", fontSize: 12, margin: "0 0 6px" }}>
                  How the LLM slices your script into scenes and what each visual should depict.
                </p>
                <textarea
                  className="textarea"
                  rows={10}
              ...
              <div>
                ...
                <p style={{ color: "var(--fg-faint)", fontSize: 12, margin: "0 0 6px" }}>
                  The look applied to every image (e.g. “cinematic, film-grain, moody light”).
                </p>
                <textarea
                  className="textarea"
                  rows={4}
